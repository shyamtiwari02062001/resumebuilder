    ...
    <div style={{ margin: "10px" }}>
      ...
      <div className="look">
        ...
        <div className="flex">
          ...
          <br />
          <input type={"email"} placeholder="Email Id" className="input2" />
        </div>
      </div>
      <div className="look">
        <div className="flex">
      ...
      <div className="look">
        <div className="flex">
          ...
          <br />
          <textarea className="textarea" placeholder="Area of Interest" />
        </div>
        <div className="flex">
          <label className="label">Address</label>
          <br />
          <textarea className="textarea" placeholder="Permanent Address" />
        </div>
      </div>
      <div className="look">
        <div className="flex">
          ...
          <br />
          <input className="input3" placeholder="List of langauges known" />
        </div>
      </div>
    </div>
  );
